	...
	Для каждого Ит Из Объект.ПравилаОбъединения Цикл  		  		
	   ...
	   КонецПопытки;  		
		...
		Иначе
			...
			Если Ит.Параметр = Справочники.Нутриенты.Белки Тогда
				ДанныеЗаполнения.Вставить("Белки", Результат);	
			ИначеЕсли Ит.Параметр = Справочники.Нутриенты.Жиры Тогда 
				ДанныеЗаполнения.Вставить("Жиры", Результат);
			ИначеЕсли Ит.Параметр = Справочники.Нутриенты.Углеводы Тогда 
				ДанныеЗаполнения.Вставить("Углеводы", Результат);
			ИначеЕсли Ит.Параметр = Справочники.Нутриенты.Калорийность Тогда 
				ДанныеЗаполнения.Вставить("Калорийность", Результат);
			КонецЕсли; 
