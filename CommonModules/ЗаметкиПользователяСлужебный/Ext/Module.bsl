...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Если Не ПравоДоступа("Редактирование", Метаданные.Справочники.Заметки) Тогда
		Возврат;
	КонецЕсли;
	...
	Разделы = ПринадлежностьОбъектов[Метаданные.Справочники.Заметки.ПолноеИмя()];
	
	Если Разделы = Неопределено Тогда
		Возврат; // Заметки не вынесены в командный интерфейс пользователя.
	КонецЕсли;
	...
	Для Каждого Раздел Из Разделы Цикл
		...
		Дело.Идентификатор = "ЗаметкиПользователя";
